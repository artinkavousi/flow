...
import {
  ...
  mergeVertices,
  toCreasedNormals
} from "./chunk-QTJIXNDR.js";
import {
  Events
} from "./chunk-JD342KBM.js";
import {
  addAfterEffect,
  addEffect,
  applyProps,
...
import "./chunk-L2SGFB2J.js";
import {
  _extends,
  useGesture
} from "./chunk-3GQLVXC5.js";
import {
  require_client
} from "./chunk-ZQ4HFC4O.js";
import {
  require_react
...
var Billboard = React13.forwardRef(function Billboard2({
  ...
  useFrame(({
    ...
    if (lockX)
      inner.current.rotation.x = prevRotation.x;
    if (lockY)
      inner.current.rotation.y = prevRotation.y;
    if (lockZ)
      inner.current.rotation.z = prevRotation.z;
  });
...
var Effects = React23.forwardRef(({
  ...
  if (!disableRenderPass)
    passes.push(React23.createElement("renderPass", {
      key: "renderpass",
      attach: `passes-${passes.length}`,
      args: [scene, camera]
    }));
  if (!disableGamma)
    passes.push(React23.createElement("shaderPass", {
      attach: `passes-${passes.length}`,
      key: "gammapass",
...
var Image = React26.forwardRef((props, ref) => {
  if (props.url)
    return React26.createElement(ImageWithUrl, _extends({}, props, {
      ref
    }));
  else if (props.texture)
    return React26.createElement(ImageWithTexture, _extends({}, props, {
      ref
    }));
  else
...
function createSpread(child, {
  ...
  if (inject) {
    ...
    else if (React32.isValidElement(inject))
      spread = {
        ...spread,
        children: inject
      };
  ...
  React34.useLayoutEffect(() => {
    ...
    if (parent) {
      ...
      if (!rotation3 || typeof rotation3 === "number") {
        ...
        if (parent.geometry.attributes.normal === void 0)
...
function createWorker(self) {
  ...
  function sortSplats(view, hashed = false) {
    ...
    for (let i2 = 1; i2 < 256 * 256; i2++)
      starts0[i2] = starts0[i2 - 1] + counts0[i2 - 1];
    const depthIndex = new Uint32Array(validCount);
    for (let i2 = 0; i2 < validCount; i2++)
      depthIndex[starts0[sizeList[i2]]++] = validIndexList[i2];
    return depthIndex;
  }
  self.onmessage = (e) => {
    if (e.data.method == "push") {
      if (offset === 0)
        matrices = new Float32Array(e.data.length);
...
function pushDataBuffer(shared, buffer, vertexCount) {
  ...
  for (let i2 = 0; i2 < vertexCount; i2++) {
    ...
    for (let j = 0; j < 16; j++)
      matrices[i2 * 16 + j] = mtx.elements[j];
  }
  while (vertexCount > 0) {
    let width = 0;
    let height = 0;
...
function useMotion() {
  ...
  if (!context12)
    throw new Error("useMotion hook must be used in a MotionPathControls component.");
  return context12;
}
function Debug({
  points = 50,
...
var MotionPathControls = React53.forwardRef(({
  ...
  React53.useLayoutEffect(() => {
    ...
    for (let i2 = 0; i2 < _curves.length; i2++)
      path.add(_curves[i2]);
    if (smooth) {
...
async function getHls(...args) {
  var _HLSModule2;
  (_HLSModule2 = _HLSModule) !== null && _HLSModule2 !== void 0 ? _HLSModule2 : _HLSModule = await import("./hls-4NUTU3J3.js");
  ...
  React66.useEffect(() => {
    if (stats) {
      ...
      if (classNames.length)
        stats.dom.classList.add(...classNames);
      const begin = addEffect(() => stats.begin());
      const end = addAfterEffect(() => stats.end());
      return () => {
        if (classNames.length)
          stats.dom.classList.remove(...classNames);
...
var StatsGl = React67.forwardRef(function StatsGl2({
  ...
  React67.useEffect(() => {
    if (stats) {
      ...
      if (id)
        stats.domElement.id = id;
      if (clearStatsGlStyle)
        stats.domElement.removeAttribute("style");
      stats.domElement.removeAttribute("style");
      const classNames = (className !== null && className !== void 0 ? className : "").split(" ").filter((cls) => cls);
      if (classNames.length)
        stats.domElement.classList.add(...classNames);
      const end = addAfterEffect(() => stats.update());
      return () => {
        if (classNames.length)
          stats.domElement.classList.remove(...classNames);
...
// node_modules/@react-three/drei/node_modules/three-mesh-bvh/src/core/build/buildUtils.js
var float32Array;
var uint32Array;
var uint16Array;
var uint8Array;
...
// node_modules/@react-three/drei/node_modules/three-mesh-bvh/src/objects/MeshBVHHelper.js
var boundingBox3 = new Box3();
var matrix2 = new Matrix4();

// node_modules/@react-three/drei/node_modules/three-mesh-bvh/src/debug/Debug.js
var _box12 = new Box3();
var _box22 = new Box3();
...
// node_modules/@react-three/drei/node_modules/three-mesh-bvh/src/gpu/VertexAttributeTexture.js
...
// node_modules/@react-three/drei/node_modules/three-mesh-bvh/src/gpu/MeshBVHUniformStruct.js
...
// node_modules/@react-three/drei/node_modules/three-mesh-bvh/src/utils/StaticGeometryGenerator.js
...
// node_modules/@react-three/drei/node_modules/three-mesh-bvh/src/gpu/BVHShaderGLSL.js
...
// node_modules/@react-three/drei/node_modules/three-mesh-bvh/src/gpu/glsl/common_functions.glsl.js
...
// node_modules/@react-three/drei/node_modules/three-mesh-bvh/src/gpu/glsl/bvh_distance_functions.glsl.js
...
// node_modules/@react-three/drei/node_modules/three-mesh-bvh/src/gpu/glsl/bvh_ray_functions.glsl.js
...
// node_modules/@react-three/drei/node_modules/three-mesh-bvh/src/gpu/glsl/bvh_struct_definitions.glsl.js
...
// node_modules/@react-three/drei/node_modules/three-mesh-bvh/src/index.js
...
var PositionMesh = class extends Group {
  ...
  raycast(raycaster, intersects) {
    ...
    if (parent.material instanceof Material)
      _mesh2.material.side = parent.material.side;
    else
      _mesh2.material.side = parent.material[0].side;
...
var Instances = React80.forwardRef(({
  ...
  const [[matrices, colors2]] = React80.useState(() => {
    ...
    for (let i2 = 0; i2 < limit; i2++)
      tempMatrix3.identity().toArray(mArray, i2 * 16);
...
var SpriteAnimator = React81.forwardRef(({
  ...
  const runAnimation = () => {
    if (!isSpriteData(spriteData.current))
      return;
    const {
      meta: {
        size: metaInfo
  ...
  function multiplyScale(initialScale = new Vector3(1, 1, 1), newScale = 1) {
    if (typeof newScale === "number")
      return initialScale.multiplyScalar(newScale);
    if (Array.isArray(newScale))
      return initialScale.multiply(new Vector3(...newScale));
    if (newScale instanceof Vector3)
      return initialScale.multiply(newScale);
  }
  ...
  React89.useLayoutEffect(() => {
    ...
    if (geometry2) {
      ...
      parent.material.forEach((material, index) => {
        if (index < parent.material.length - 1)
...
function SpotLightShadow(props) {
  if (props.shader)
    return React106.createElement(SpotlightShadowWithShader, props);
...
var Cloud = React110.forwardRef((props, fref) => {
  const parent = React110.useContext(context7);
  if (parent)
    return React110.createElement(CloudInstance, _extends({
      ref: fref
    }, props));
...
var Points = React117.forwardRef((props, forwardedRef) => {
  if (props.positions instanceof Float32Array) {
    ...
    return React117.createElement(PointsInstances, _extends({}, props, {
      ref: forwardedRef
    }));
});
...
var View = (() => {
  const _View = React129.forwardRef((props, fref) => {
    ...
    if (!store)
      return React129.createElement(HtmlView, _extends({
        ref: fref
      }, props));
    else
      return React129.createElement(CanvasView, _extends({
        ref: fref
      }, props));
  });
  ...
  React138.useEffect(() => {
    ...
    if (scaleRef.current) {
      ...
      if (width || height || depth) {
        ...
        if (width)
          scale3 = width / bboxSize.x;
        if (height)
          scale3 = height / bboxSize.y;
        if (depth)
          scale3 = depth / bboxSize.z;
      }
...
var FaceLandmarker = (0, import_react22.forwardRef)(({
  ...
  const faceLandmarker = suspend(async () => {
    ...
    } = await import("./vision_bundle-VJAENWQ4.js");
