...
var Depth = class _Depth extends Abstract {
  constructor(props) {
    super(_Depth, {
      ...
      const mapping = _Depth.getMapping(self2.uuid, self2.mapping);
...
var Noise = class _Noise extends Abstract {
  constructor(props) {
    super(_Noise, {
      ...
      const noiseFunc = _Noise.getNoiseFunction(self2.type);
      const mapping = _Noise.getMapping(self2.mapping);
...
var Gradient = class _Gradient extends Abstract {
  constructor(props) {
    super(_Gradient, {
      ...
      const mapping = _Gradient.getMapping(self2.mapping);
...
var Displace = class _Displace extends Abstract {
  constructor(props) {
    super(_Displace, {
      ...
      const noiseFunc = _Displace.getNoiseFunction(self2.type);
      const mapping = _Displace.getMapping(self2.mapping);
